      ...
      <div class="w-full mx-auto mt-6 sm:mt-8">
        <div class="relative">
          ...
          <div class="absolute -top-2 left-4 sm:-top-3 sm:left-6 z-20">
            <span class="inline-flex items-center gap-1 px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs font-semibold bg-blue-600 text-white shadow-lg">
              <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
              </svg>
              <span class="hidden sm:inline">NEW AI FEATURE</span>
            ...
            <div class="p-4 sm:p-6 md:p-8 lg:p-10 h-full flex flex-col">
              <div class="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <div class="flex-1 min-w-0">
                  <h3 class="text-sm sm:text-lg font-semibold text-gray-900 truncate">AI Home Expert</h3>
                  <p class="text-xs text-gray-500 hidden sm:block">Advanced intelligence for your home's exterior</p>
                </div>
                <span class="inline-flex items-center gap-1 px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 flex-shrink-0">
