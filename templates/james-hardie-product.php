    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="order-2 lg:order-1">
                <?php 
                // Use generic James Hardie product placeholder
                $placeholderImage = 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&h=800&fit=crop&q=80';
                ?>
                <img src="<?= htmlspecialchars($placeholderImage) ?>" 
