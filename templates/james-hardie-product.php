    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="order-2 lg:order-1">
                <?php if (isset($product['Image Path']) && !empty($product['Image Path'])): ?>
                    <img src="<?= htmlspecialchars($product['Image Path']) ?>" 
                         alt="<?= htmlspecialchars($product['Product Name']) ?>"
                         class="w-full h-auto rounded-2xl shadow-xl"
                         loading="lazy">
                <?php else: ?>
                    <div class="w-full h-96 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl shadow-xl flex items-center justify-center border-2 border-dashed border-gray-300">
                        <div class="text-center px-8">
                            <svg class="w-24 h-24 mx-auto text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                            </svg>
                            <p class="text-gray-600 font-semibold text-lg mb-2">Product Image</p>
